          ...
          <div className="space-y-2">
            ...
            {categories.map(cat => (
              <button
                ...
                className={`w-full flex items-center justify-between p-3 rounded-xl transition-enterprise ${
                  category === cat ? 'bg-primary/10 text-primary border border-primary/20' : 'text-text-secondary hover:bg-surface-2'
                }`}
              >
        ...
        <div className="p-8 bg-bg border-t border-border-subtle space-y-6 shadow-[0_-10px_40px_rgba(0,0,0,0.4)]">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className={`h-16 rounded-xl border flex flex-col items-center justify-center gap-1 transition-enterprise ${
                paymentMethod === 'CASH' ? 'bg-primary text-bg border-primary' : 'bg-surface-2 text-text-secondary border-border-subtle'
              }`}
            >
              <Banknote size={20} />
            ...
            <button
              ...
              className={`h-16 rounded-xl border flex flex-col items-center justify-center gap-1 transition-enterprise ${
                paymentMethod === 'CARD' ? 'bg-primary text-bg border-primary' : 'bg-surface-2 text-text-secondary border-border-subtle'
              }`}
            >
              <CreditCard size={20} />
